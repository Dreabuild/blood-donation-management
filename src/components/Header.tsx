  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-x-2 sm:gap-x-4">
            <a
              ...
              className=" text-[#BF0000] text-sm sm:text-lg lg:text-xl px-2 py-1 sm:px-3 sm:py-2 hover:px-4 transition-all"
              data-aos="fade-down"
              data-aos-anchor-placement="center-bottom"
              data-aos-delay="200"
              data-aos-duration="500"
            ...
            <a
              ...
              className="bg-[#BF0000] text-[#fff] text-sm sm:text-lg lg:text-xl px-2 py-2 sm:px-3 sm:py-2 flex items-center gap-x-1 sm:gap-x-2 lg:gap-x-3 hover:gap-x-4 transition-all"
              data-aos="fade-left"
              data-aos-anchor-placement="center-bottom"
              data-aos-delay="300"
              data-aos-duration="500"
            >
              Hospitals Waitlist <FaArrowRightLong />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto flex flex-col items-center justify-center min-h-[60vh] lg:min-h-[70vh] py-8">
        ...
        <p
          className="text-[#fff] text-2xl sm:text-[36px] lg:text-[56px] font-bold text-center"
          data-aos="fade-up"
          data-aos-anchor-placement="center-bottom"
          data-aos-delay={400}
          data-aos-duration="500"
        ...
        <p
          className="text-[#F9E6E6] text-xl sm:text-3xl lg:text-[42px] text-center mt-2 lg:mt-8"
          data-aos="fade-up"
          data-aos-anchor-placement="center-bottom"
          data-aos-delay={600}
          data-aos-duration="500"
        ...
        <a
          ...
          data-aos-duration="500"
        >
          Project Guide <FaArrowRightLong />
        </a>
      </div>
    </div>
  );
